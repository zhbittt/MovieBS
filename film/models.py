...
class UserInfo(models.Model):
    ...
    head_img = models.FileField(verbose_name='头像', upload_to='upload', default="/media/upload/default.jpg")
...
class MovieField(models.Model):
    ...
    movie = models.ForeignKey(verbose_name="电影",to="MovieDetail",on_delete=models.CASCADE)
...
class OrderDetail(models.Model):
    ...
    moviefield = models.ForeignKey(to="MovieField",on_delete=models.CASCADE)
